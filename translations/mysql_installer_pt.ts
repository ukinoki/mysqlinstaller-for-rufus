...
Voulez-vous vraiment continuer ?</source>
        <translation>⚠️ TODOS OS SEUS DADOS SERÃO PERDIDOS DEFINITIVAMENTE se continuar.

Esta operação desinstala o MySQL e apaga todas as suas bases de dados, incluindo os dados geridos pelo Rufus. É IRREVERSÍVEL.

FAÇA UMA CÓPIA DE SEGURANÇA dos seus dados antes de prosseguir.

(A pasta partilhada e os ficheiros que contém não são apagados.)
...
⚠️ A atualização efetua uma LIMPEZA COMPLETA: o MySQL é totalmente desinstalado e depois reinstalado de raiz. A base de dados existente será APAGADA DEFINITIVAMENTE.
...
Détail (%2) :
%3</source>
        <translation>O MySQL está instalado mas não foi possível inicializar a base de dados (%1/data).

O servidor não consegue arrancar.
...
Vous pourrez ensuite le lancer comme un logiciel installé, sans repasser par ce fichier.</source>
        <translation>Deseja adicionar «MySQL Installer for Rufus» ao menu de aplicativos?

Depois poderá iniciá-lo como um programa instalado, sem precisar usar este ficheiro novamente.</translation>
    </message>
    <message>
...
L&apos;application va maintenant démarrer.</source>
        <translation>«MySQL Installer for Rufus» foi adicionado ao menu de aplicativos.

O aplicativo será iniciado agora.</translation>
    </message>
    <message>
...
L&apos;application va tout de même démarrer.</source>
        <translation>Não foi possível concluir a adição ao menu.
O aplicativo será iniciado mesmo assim.</translation>
    </message>
    <message>
